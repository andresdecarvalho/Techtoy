              ...
              <div class="card-body">
                ...
                <form action="ServletUsuario?cmd=atualizar" method="post">                     
                  <div class="form-group">
                    ...
                    value="<%= usuario.getCodUsuario() %>" readonly="readonly"
                    ><br>
                    <label>Nome:</label>
                    ...
                    value="<%= usuario.getEmailUsuario() %>" 
                    ><br>
                    <label>Senha:</label>
                    <input type="text" class="form-control" name="senhaUsuario"
                    value="<%= usuario.getSenhaUsuario() %>"
                    >					
                  </div>                                                                                                
