        ...
        <div class="row">
          ...
          <div class="col-sm-8">
            <div class="card" style="height: auto;">
              <div class="card-body">
                <h5 class="card-title">Exclusão da Categoria</h5>
                ...
                <form action="ServletCategoria?cmd=excluir" method="post">                     
                  <div class="form-group">
                    ...
                    value="<%=categoria.getCodCategoria()%>" readonly="readonly"
                    ><br>
                    <label>Nome:</label>
                    ...
                    ><br>
                    <label>Linha:</label>
                    <input type="text" class="form-control" name="linhaCategoria" 
                    value="<%=categoria.getLinhaCategoria()%>"
                    readonly="readonly"><br>
                    <label>Faixa etária:</label>
                    <input type="text" class="form-control" name="faixaCategoria"
