              ...
              <div class="card-body">
                ...
                <form action="ServletProduto?cmd=atualizar" method="post">                     
                  <div class="form-group">
                    <label>Código:</label>
                    <input type="text" class="form-control" name="idProduto" value="<%= produto.getIdProduto() %>" readonly="readonly"><br>
                    <label>Nome:</label>
                    <input type="text" class="form-control" name="nomeProduto" value="<%= produto.getNomeProduto() %>"><br>
                    <label>Descrição:</label>
                    <input type="text" class="form-control" name="descProduto" value="<%= produto.getDescProduto() %>"><br>
                    <label>Foto:</label>
                    <input type="file" id="formFile" class="form-control" name="fotoProduto" accept="image/*" value="<%= produto.getFotoProduto() %>"><br>
                    <label>Preço:</label>
                    <input type="text" class="form-control" name="precoProduto" value="<%= produto.getPrecoProduto() %>"><br>
                    <label>Categoria:</label>
                    <input type="text" class="form-control" name="codCategoria" value="<%= produto.getCodCategoria()
                    %>">						
                  </div>                                                                                              
