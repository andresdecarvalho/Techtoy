        ...
        <a class="navbar-brand" href="index.jsp"><img id="logo" src="./imgs/logo_novo.png" alt="TechToy" style="width:40px"><b> | TechToy</b></a>
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navbar-links" >
            <div class="navbar-nav">
              <a href="areaadministrativa.jsp" class="nav-item nav-link" id="about-menu" style="color: azure;">Area Administrativa</a>
            </div>
          </div>                 
        </nav>
                  ...
                  <div class="card-body">
                    <h5 class="card-title"><b>Lista de Produtos</b></h5>                                         
						<table class="table table-hover">
							...
							listap = (ArrayList)request.getAttribute("produtosList");
