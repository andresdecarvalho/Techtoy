				...
				<div class="row">
					...
					<div class="col-sm-8">
						<div class="card" style="height: auto;">
							<div class="card-body">
								<h5 class="card-title"><b>Lista de Categorias</b></h5>                                          
									<table class="table table-hover">
										...
										<tbody>
											...
											<td><%=a.getNomeCategoria()%></td>
											<td><%=a.getLinhaCategoria()%></td>
											<td><%=a.getFaixaCategoria()%></td>
											<td><a type="button" class="btn-lg btn-success" style="height: auto; widght: auto; font-size: 13px" href=<%="ServletCategoria?cmd=atu&codCategoria=".concat(String.valueOf(a.getCodCategoria()))%>>Alterar</a></td>
											<td><a type="button" class="btn-lg btn-danger" style="height: auto; widght: auto; font-size: 13px" href=<%="ServletCategoria?cmd=exc&codCategoria=".concat(String.valueOf(a.getCodCategoria()))%>>Excluir</a></td>
											</tr>
											<%
											}
											%>
