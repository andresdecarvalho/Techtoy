              ...
              <div class="card-body">
                ...
                <input type="hidden" name="cmd" value="incluir"> <br/>                    
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="descProduto" size="60" maxlength="60"
                    ><br>
                    <label>Foto:</label>
                    <input type="file" class="form-control-file" name="fotoProduto" 
                    accept="image/*" ><br>
                    <label>Preço R$:</label>
                    <input type="text" class="form-control" name="precoProduto" size="60" maxlength="60" placeholder="R$:"
                    ><br>
                    <label>Categoria:</label>
                    <input type="text" class="form-control" name="codCategoria" size="60"
                    maxlength="60" ><br>					
                  </div>                                                                                       
                  <button type="submit" class="btn btn-outline-dark">Incluir</button>        
                </form> 
              </div>
            </div>            
          </div>   
